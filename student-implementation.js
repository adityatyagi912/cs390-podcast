...
async function fetchNews() {
    ...
    try {
        ...
        const articles = (response && response.data && response.data.articles) ? response.data.articles : [];
...
async function generateScript(articles) {
    ...
    try {
        ...
        const script = (response && response.data && response.data.choices && response.data.choices[0] && response.data.choices[0].message)
        ...
        try {
            ...
            console.warn('⚠️  Failed to save script file:', e.message || e);
        }
